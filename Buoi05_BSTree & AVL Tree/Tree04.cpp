...
void Menu3() {
	...
	cout << "20. Xuat cac so hoan thien trong cay." << endl;
	cout << "21. Xuat cay theo tang." << endl;
	cout << "22. Liet ke nut co gia tri chan." << endl;
	cout << "23. Dem so luong nut co 1 con va la so nguyen to" << endl;
	cout << "24. Dem so luong nut co 2 con va la so chinh phuong." << endl;
	cout << "25. Dem nut nam o tang thap hon k" << endl;
	cout << "26. Dem nut nam cao hon tang k cua cay" << endl;
	cout << "27. Tinh tong phan tu le." << endl;
	cout << "28. Tinh tong nut gia tri le khong phai la." << endl;
	cout << "29. Tinh tong nut co 1 con va la so nguyen to." << endl;
	cout << "30. Tinh tong nut co 2 con va la so chinhs phuown" << endl;
	cout << "31. Kiem tra cay co phai la cay nhi phan tim kiem hay khong." << endl;
	cout << "32. Kiem tra cay co can bang hay khong." << endl;
	cout << "33. Kiem tra cay co can bang hoan toan hay khong." << endl;
	cout << "**************************************************" << endl;
	cout << "\tOPTION: ";
}
void End() {
		...
		case 6: {
			...
			do {
				...
				case 20: {
					...
					print_ascii_tree(tr.Root);
					cout << endl;
					cout << "Cac so hoan thien trong cay: ";
					ListedPerfectNum(tr.Root);
					cout << endl;
					End();
					break;
				}
				case 21: {
					...
					print_ascii_tree(tr.Root);
					cout << endl;
					int h = HeightTree(tr.Root);
					for (int k = 0; k < h; k++) {
						cout << "Phan tu o tang " << k << " la:";
						ListedLevel(tr.Root, k);
						cout << endl;
					}
					End();
				...
				case 22: {
					...
					print_ascii_tree(tr.Root);
					cout << endl;
					cout << "Nut co gia tri chan la: ";
					ListedEvennum(tr.Root);
					cout << endl;
					End();
					break;
				}
				case 23: {
					...
					print_ascii_tree(tr.Root);
					cout << endl;
					cout << "so luong la: " << CountNodeHasOneChildPrime(tr.Root) << endl;
					End();
					break;
				}
				case 24: {
					...
					print_ascii_tree(tr.Root);
					cout << endl;
					cout << "So luong la: " << CountNodeHasTwoChildPerfectSquare(tr.Root) << endl;
					End();
					break;
				}
				case 25: {
					...
					int cnt = 0;
					int h = HeightTree(tr.Root);
					cout << "Nhap tang thu k: "; int k; cin >> k;
					if (k >= h) {
						cerr << "Loi gia tri!"<<endl;
						End();
						break;
					}
					for (int i = 0; i < k; i++) {
						cnt += CountNodeLevel(tr.Root, i);
					}
				...
				case 27: {
					...
					print_ascii_tree(tr.Root);
					cout << endl;
					cout << "Tong la: " << SumOddNum(tr.Root)<<endl;
					End();
					break;
				}
				case 28: {
					...
					print_ascii_tree(tr.Root);
					cout << endl;
					cout << "Tong la: " << SumOddNumNotLeaf(tr.Root) << endl;
					End();
					break;
				}
				case 29: {
					...
					print_ascii_tree(tr.Root);
					cout << endl;
					cout << "Tong la: " << SumNodeHasOneChildPrime(tr.Root) << endl;
					End();
					break;
				}
				case 30: {
					...
					print_ascii_tree(tr.Root);
					cout << endl;
					cout << "Tong la: " << SumNodeHasTwoChildPerfectSquare(tr.Root) << endl;
					End();
					break;
				}
				case 31: {
					...
					print_ascii_tree(tr.Root);
					cout << endl;
					if (CheckBinarySearchTree(tr.Root)) {
						cout << "Cay da tao la cay nhi phan tim kiem." << endl;
						cout << "check ham o file \'CalulationTree.cpp\'/line_383." << endl;
					}
					else cout<<"Cay da tao khong phai la cay nhi phan tim kiem." << endl;
					End();
					break;
				}
				case 32: {
					...
					print_ascii_tree(tr.Root);
					cout << endl;
					if (CheckBalance(tr.Root)) {
						cout << "Cay da tao can bang." << endl;
					}
					else cout << "Cay da tao khong can bang." << endl;
					End();
					break;
				}
				case 33: {
					...
					print_ascii_tree(tr.Root);
					cout << endl;
					if (CheckPerfectBalance(tr.Root)) {
						cout << "Cay da tao can bang hoan toan." << endl;
					}
					else cout << "Cay da tao khong can bang hoan toan." << endl;
					End();
					break;
				}
				}
